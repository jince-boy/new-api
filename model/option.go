...
func InitOptionMap() {
	...
	common.OptionMap["CustomNavLinks"] = "[]"
	...
	common.OptionMap["MinAffTransferQuota"] = strconv.Itoa(common.MinAffTransferQuota)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviterRewardType":
		common.InviterRewardType = value
	case "InviterRewardValue":
		common.InviterRewardValue, _ = strconv.Atoi(value)
	case "MinAffTransferQuota":
		common.MinAffTransferQuota, _ = strconv.Atoi(value)
