...
RUN set -eux; \
    ...
    (rm -rf /root/.bun/install/cache /tmp/* && bun install --frozen-lockfile --registry "https://registry.npmjs.org") || \
    (rm -rf /root/.bun/install/cache /tmp/* && bun install --frozen-lockfile --registry "https://registry.npmmirror.com")
COPY ./web ./
