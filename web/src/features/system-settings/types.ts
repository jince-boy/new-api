...
export type ModelSettings = {
  ...
  'billing_setting.per_second_rules': string
  ...
  'monitor_setting.channel_test_mode': 'scheduled_all' | 'auto_ban_only'
...
export type BillingSettings = {
  ...
  InviterRewardType: '' | 'fixed' | 'percentage' | string
  InviterRewardValue: number
  MinAffTransferQuota: number
  TopUpLink: string
