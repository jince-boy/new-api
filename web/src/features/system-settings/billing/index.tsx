...
const defaultBillingSettings: BillingSettings = {
  ...
  'invoice_setting.urban_maintenance_tax_rate_basis_points': 0,
  'invoice_setting.education_surcharge_rate_basis_points': 0,
  'invoice_setting.local_education_rate_basis_points': 0,
  'invoice_setting.surcharge_relief_basis_points': 0,
  'invoice_setting.pit_withholding_enabled': false,
  'invoice_setting.policy_effective_date': '2026-01-01',
  'invoice_setting.policy_notice':
    '发票项目和金额应与实际业务及订单一致；如需补税，由管理员根据实际开票结果确认。',
