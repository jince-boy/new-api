...
export function SmartProtectionReviewError(props: { error: string }) {
    ...
    <Popover>
      <PopoverTrigger
        render={
          <button
            ...
            aria-label={t('Show upstream review error')}
      ...
      >
        <div className='flex flex-col gap-2'>
          <p className='font-medium'>{t('Upstream review response')}</p>
