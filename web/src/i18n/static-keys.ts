...
export const STATIC_I18N_KEYS = [
  ...
  'Maximum channels attempted per request',
  ...
  // Advanced Custom protocol validation
  'Async task routes must use native forwarding',
  'Submit method is invalid',
  'Task request mode is invalid',
  'Task body template is required in template mode',
  'Task body template requires template mode',
  'Submit task ID path is required',
  'Poll method is invalid',
  'Poll upstream path is required',
  'Poll upstream path must contain {task_id}',
  'Poll upstream path must be a full URL or a path starting with /',
  'GET poll requests cannot include a body template',
  'Poll status path is required',
  'Poll result URL path is required',
  'Poll status map is required',
  'Poll status map contains an invalid status',
  'Header name is required',
  'Header name or value is invalid',
  'JSON template routes must use native forwarding',
  'Synchronous JSON templates cannot be combined with an async task protocol',
  'Upstream HTTP method is invalid',
  'Task routes must use the submit method setting',
