...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/statusline/me", middleware.TokenAuthReadOnly(), controller.GetStatuslineMe)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/details", controller.GetInvitationDetails)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/default_chat_key", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.GetDefaultChatTokenKey)
			tokenRoute.GET("/default_key_purposes", middleware.DisableCache(), controller.GetDefaultTokenKeyPurposes)
			tokenRoute.GET("/default_key/:purpose", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.GetDefaultTokenKey)
			tokenRoute.GET("/:id", controller.GetToken)
			tokenRoute.POST("/:id/key", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.GetTokenKey)
			tokenRoute.PUT("/:id/default_chat", controller.SetDefaultChatToken)
			tokenRoute.PUT("/:id/default/:purpose", controller.SetDefaultToken)
		...
		apiRouter.GET("/log", middleware.AdminAuth(), controller.GetAllLogs)
		...
		dataRoute.GET("/token-ranking", middleware.UserAuth(), controller.GetTokenRanking)
