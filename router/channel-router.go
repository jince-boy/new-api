...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/scheduling/overview", permission: authz.ChannelRead, handler: controller.GetChannelSchedulingOverview},
	{method: http.MethodGet, path: "/scheduling/settings", permission: authz.ChannelRead, handler: controller.GetChannelSchedulingSetting},
	{method: http.MethodPut, path: "/scheduling/settings", permission: authz.ChannelWrite, handler: controller.UpdateChannelSchedulingSetting},
	{method: http.MethodPost, path: "/scheduling/model/restore", permission: authz.ChannelOperate, handler: controller.RestoreChannelModelScheduling},
	{method: http.MethodPost, path: "/scheduling/model/disable", permission: authz.ChannelOperate, handler: controller.DisableChannelModelScheduling},
	{method: http.MethodPost, path: "/scheduling/channel/restore", permission: authz.ChannelOperate, handler: controller.RestoreChannelScheduling},
	{method: http.MethodPost, path: "/scheduling/channel/disable", permission: authz.ChannelOperate, handler: controller.DisableChannelScheduling},
